...
if not exists (select * from Reports where ReportFileName = 'Validations.rpt')
begin

    insert into Reports values (1, 1, 'Validations.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Validations');
end