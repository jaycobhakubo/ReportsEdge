...
begin
    insert into Reports values (1, 1, 'CannerySessionSummaryRecapCashBased.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Session Summary Recap Cash Based');
end