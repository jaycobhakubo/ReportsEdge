...
/****** Object:  StoredProcedure [dbo].[spRptCanneryGroupedSessionSummaryQTD]    Script Date: 08/14/2017 16:44:01 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptCanneryGroupedSessionSummaryQTD]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptCanneryGroupedSessionSummaryQTD]
GO
...
-- Description:	Cannery Session Summary Recap Quarter to Date
--				Cannery Casino version of the spRptGroupedSessionSummaryReport
--              to include station bucks.
-- =============================================


CREATE PROCEDURE [dbo].[spRptCanneryGroupedSessionSummaryQTD]
	@OperatorID as int,
