...
if not exists (select * from Reports where ReportFileName = 'PlayerSpendByDate.rpt')
begin

    insert into Reports values (3, 1, 'PlayerSpendByDate.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Player Spend by Date');
end