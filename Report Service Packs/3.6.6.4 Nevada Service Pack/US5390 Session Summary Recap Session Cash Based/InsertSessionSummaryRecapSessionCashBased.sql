...
if not exists (select * from Reports where ReportFileName = 'SessionSummaryRecapCashBasedSessionTotals.rpt')
begin

    insert into Reports values (1, 0, 'SessionSummaryRecapCashBasedSessionTotals.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Session Summary - Session (Cash Based) ');
end