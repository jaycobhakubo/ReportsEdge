...
if not exists (select * from Reports where ReportFileName = 'BusSalesByDate.rpt')
begin

    insert into Reports values (1, 1, 'BusSalesByDate.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Bus Sales by Date');
end