...
if not exists (select * from Reports where ReportFileName = 'TotalPointLiability.rpt')
begin

    insert into Reports values (3, 1, 'TotalPointLiability.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Total Point Liability');
end