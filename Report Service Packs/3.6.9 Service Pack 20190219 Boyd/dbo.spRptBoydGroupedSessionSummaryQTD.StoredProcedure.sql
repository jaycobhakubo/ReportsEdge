...
/****** Object:  StoredProcedure [dbo].[spRptBoydGroupedSessionSummaryQTD]    Script Date: 02/20/2019 09:22:14 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptBoydGroupedSessionSummaryQTD]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptBoydGroupedSessionSummaryQTD]
GO

USE [Daily]
GO

/****** Object:  StoredProcedure [dbo].[spRptBoydGroupedSessionSummaryQTD]    Script Date: 02/20/2019 09:22:15 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Boyd Session Summary Recap Quarter to Date
...
CREATE PROCEDURE [dbo].[spRptBoydGroupedSessionSummaryQTD]
	@OperatorID as int,
