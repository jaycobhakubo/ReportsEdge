...
if not exists (select * from Reports where ReportFileName = 'CardLevelDistribution.rpt')
begin

    insert into Reports values (4, 1, 'CardLevelDistribution.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Card Level Distribution');
end