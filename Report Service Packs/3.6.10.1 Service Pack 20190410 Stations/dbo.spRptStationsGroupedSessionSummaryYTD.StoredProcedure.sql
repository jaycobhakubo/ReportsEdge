...
/****** Object:  StoredProcedure [dbo].[spRptStationsGroupedSessionSummaryYTD]    Script Date: 04/10/2019 14:37:50 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptStationsGroupedSessionSummaryYTD]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptStationsGroupedSessionSummaryYTD]
GO
...
-- Description:	Stations Session Summary Recap Year to Date
...
CREATE PROCEDURE [dbo].[spRptStationsGroupedSessionSummaryYTD]
	@OperatorID as int,
