...
begin
    insert into Reports values (1, 1, 'RegisterSalesByProductType.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Register Sales by Product Type');
end