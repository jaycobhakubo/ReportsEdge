...
/****** Object:  StoredProcedure [dbo].[spRptUnitTransfers]    Script Date: 05/30/2013 15:51:05 ******/
...
-- Author:		GameTech
-- Description:	<>
-- 2013.05.30 tmp: US2653 add serial number from/to
-- 20150928(knc): Coupon sales added.
-- =============================================
...
SELECT DISTINCT
	xFromTransaction as TransactionNumber,
	UnitNumber,
	xSerialNumber1 as SerialNumber,
	RR.SoldToMachineID, 
	zPackNumber as PackNumber, 
	D.DeviceType as FromDevice,
	D1.DeviceType as ToDevice,
	 (select DTStamp from RegisterReceipt where RegisterReceiptID = xOriginalReceiptID) as DTStamp,
    Left(UPPER(S.FirstName),1) + ' ' + S.LastName as SoldStaffName,
	RR.OperatorID,  
	SP.GamingDate, 	
	xFromUnit as FromUnitNumber,
	xSerialNumber2 as FromSerialNumber,
	xToTrans as ToTrans,
