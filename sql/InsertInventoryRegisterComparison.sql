...
begin
	Insert into Reports Values (13, 1, 'InventoryRegisterComparison.Rpt') --Inventory
	...
	Insert into ReportLocalizations Values (@ReturnValue, 1033, 'en-US', 'Inventory Register Comparison')
End
Go