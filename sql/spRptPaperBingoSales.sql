...
/****** Object:  StoredProcedure [dbo].[spRptPaperBingoSales]    Script Date: 7/12/2013 4:42:56 PM ******/
DROP PROCEDURE [dbo].[spRptPaperBingoSales]
GO
...
CREATE proc [dbo].[spRptPaperBingoSales]
(
    @OperatorID int,
    @StartDate datetime, 
    @Session int
...
-- ============================================================================
-- 2012.06.14 jkn US2233 add support for returning CBB paper sales
...
begin
    ...
    from RegisterReceipt rr
     ...
     --   join BingoCardHeader bch on rdi.RegisterDetailItemId = bch.bchRegisterDetailItemId
		JOIN (Select Distinct bchMasterCardNo, bchRegisterDetailItemID, bchCardVoided From BingoCardHeader) as bch on (bch.bchRegisterDetailItemID = rdi.RegisterDetailItemID)
