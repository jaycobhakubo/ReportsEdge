...
begin
    insert into Reports values (1, 1, 'BarcodedPaperSalesSkipsByDateSessionStaff.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Barcoded Paper Sales Skips by Date, Session, and Staff');
end