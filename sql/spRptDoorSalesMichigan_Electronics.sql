...
/****** Object:  StoredProcedure [dbo].[spRptDoorSalesMichigan_Electronics]    Script Date: 03/07/2014 15:11:32 ******/
...
-- 2014.03.07 tmp: US3104 Added the Ted-E to the where condition deviceID. 
-- =============================================
	@OperatorID	AS INT,
