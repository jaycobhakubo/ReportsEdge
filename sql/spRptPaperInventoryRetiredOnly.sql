...
/****** Object:  StoredProcedure [dbo].[spRptPaperInventoryRetiredOnly]    Script Date: 01/28/2014 15:41:46 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptPaperInventoryRetiredOnly]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptPaperInventoryRetiredOnly]
GO
...
-----------------------------------------------------------------------------------------------------------------
-- 2014.01.28 tmp: Copied from spRptInvCenterOnHand, changed to report retired paper products only
-----------------------------------------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[spRptPaperInventoryRetiredOnly]
(	@OperatorID as int
)	
