...
/****** Object:  StoredProcedure [dbo].[spRptPayoutSummary]    Script Date: 12/12/2013 15:03:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptPayoutSummary]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptPayoutSummary]
GO
...
--exec sp_helptext 'spRptPayoutSummary'
       
CREATE PROCEDURE  [dbo].[spRptPayoutSummary]         
(        
 --=============================================        
 ----Author:  FortuNet        
 ----Description: Lists payouts made in a session        
 ----Copied from spRptPayoutDetail
 --=============================================        
 @OperatorID AS INT,        
