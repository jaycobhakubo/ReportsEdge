...
begin
    insert into Reports values (1, 1, 'BarcodedPaperSalesSummaryByDateStaff.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Barcoded Paper Sales Summary by Date and Staff');
end