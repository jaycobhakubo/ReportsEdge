...
/****** Object:  StoredProcedure [dbo].[spRptInventoryAuditDetail]    Script Date: 10/07/2013 17:54:04 ******/
...
begin
    ...
    where i.ivtGamingDate >= @StartDate
        and i.ivtGamingDate < @EndDate
    	and (@ProductTypeID = 0 or pt.ProductTypeID = @ProductTypeID)
    	and (@SerialNumber = '0' or ii.iiSerialNo = @SerialNumber)
    	and (@OperatorID = 0 or o.OperatorID = @OperatorID)
