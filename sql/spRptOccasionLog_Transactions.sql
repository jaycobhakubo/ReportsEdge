...
/****** Object:  StoredProcedure [dbo].[spRptOccasionLog_Transactions]    Script Date: 05/10/2013 10:32:42 ******/
...
-- <DE10950> - 05/10/2013 tmp: Updated the Transaction Type to include type 'Sale Failed'
-- =============================================
...
SaleSuccess Int    --1 = True 0 = False
)
...
Group By rr.RegisterReceiptID, rr.TransactionNumber, tt.TransactionType, rd.VoidedRegisterReceiptID, rr.SaleSuccess
...
and (@Session = 0 or sp.GamingSession = @Session)
--And rr.TransactionTypeID in (1, 2, 3) -- Return all transactions not just Sale, Void, Returns
Group By rr.RegisterReceiptID, rr.TransactionNumber, tt.TransactionType, rr.OriginalReceiptID, rr.SaleSuccess
Order by rr.TransactionNumber
...
Update @Results
Set TransactionType = 'Sale Failed'
Where SaleSuccess = 0
