...
/****** Object:  StoredProcedure [dbo].[spRptBingoGameAnalysis]    Script Date: 09/29/2015 10:37:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptBingoGameAnalysis]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptBingoGameAnalysis]
GO
...
CREATE procedure [dbo].[spRptBingoGameAnalysis]
(
------------------------------------------------------------------------------
-- 20150929 tmp: US4260 - Add support for multiple game categories.
------------------------------------------------------------------------------
...
Select	sgc.GameCategoryId,		--US4260
...
Join SessionGameCategory sgc on sgp.SessionGamesPlayedID = sgc.SessionGamesPlayedId    --US4260
...
--Group By sgp.GameCategoryID, sgp.GCName --US4260 
