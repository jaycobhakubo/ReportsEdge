...
/****** Object:  StoredProcedure [dbo].[spRptPlayerSpendTop10]    Script Date: 05/14/2014 16:17:47 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptPlayerSpendTop10]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptPlayerSpendTop10]
GO
...
CREATE PROCEDURE [dbo].[spRptPlayerSpendTop10]

-- ============================================================================
-- Author:		FortuNet
-- Description:	Returns the top 10 players based on spend.
