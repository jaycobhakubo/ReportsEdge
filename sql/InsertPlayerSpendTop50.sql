...
begin
    insert into Reports values (3, 1, 'PlayerSpendTop50.rpt');   -- Set Report Group and Set IsActive
    ...
    insert into ReportLocalizations values (@ReturnValue, 1033, 'en-US', 'Player Spend Top 50');
end