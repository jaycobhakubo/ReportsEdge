...
/****** Object:  StoredProcedure [dbo].[spRptSessionSummary]    Script Date: 10/07/2013 17:48:03 ******/
...
-- US2565 tmp: Modified the Crystal Ball Bingo products to report by QP or HP
-- DE10983 tmp: Correct the Crystal Ball Bingo calculation so that it does not double sales if the game is replayed
--=============================================================================
...
select CouponName, TotalSales from dbo.FindCouponSales(@OperatorID, @GamingDate, @GamingDate, @Session)
