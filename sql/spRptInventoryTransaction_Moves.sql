...
/****** Object:  StoredProcedure [dbo].[spRptInventoryTransaction_Moves]    Script Date: 05/07/2014 14:47:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptInventoryTransaction_Moves]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spRptInventoryTransaction_Moves]
GO
...
CREATE PROCEDURE [dbo].[spRptInventoryTransaction_Moves] 
	@OperatorID	as int,
...
SET NOCOUNT ON
    ...
    where ((ivt.ivtGamingDate >= @StartDate
        ...
        and ivt.ivtTransactionTypeID = 21 -- Moves
