...
namespace EdgeReports.Reports {
    ...
    public class CreditCardPayments : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.CreditCardPayments.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCreditCardPayments : Component, ICachedReport {
        
        public CachedCreditCardPayments() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CreditCardPayments rpt = new CreditCardPayments();
            rpt.Site = this.Site;
            return rpt;
        }
