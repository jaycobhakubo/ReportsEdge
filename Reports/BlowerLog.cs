...
namespace EdgeReports.Reports {
    ...
    public class BlowerLog : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.BlowerLog.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBlowerLog : Component, ICachedReport {
        
        public CachedBlowerLog() {
        }
