...
namespace EdgeReports.Reports {
    ...
    public class RaffleEntrants : ReportClass {
        
        public RaffleEntrants() {
        }
        
        public override string ResourceName {
            get {
                return "RaffleEntrants.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.RaffleEntrants.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRaffleEntrants : Component, ICachedReport {
        
        public CachedRaffleEntrants() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RaffleEntrants rpt = new RaffleEntrants();
            rpt.Site = this.Site;
            return rpt;
        }
