...
namespace EdgeReports.Reports {
    ...
    public class ExceptionDetail : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.ExceptionDetail.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedExceptionDetail : Component, ICachedReport {
        
        public CachedExceptionDetail() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ExceptionDetail rpt = new ExceptionDetail();
            rpt.Site = this.Site;
            return rpt;
        }
