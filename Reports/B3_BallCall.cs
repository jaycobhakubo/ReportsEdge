...
namespace EdgeReports.Reports {
    ...
    public class B3_BallCall : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.B3_BallCall.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedB3_BallCall : Component, ICachedReport {
        
        public CachedB3_BallCall() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            B3_BallCall rpt = new B3_BallCall();
            rpt.Site = this.Site;
            return rpt;
        }
