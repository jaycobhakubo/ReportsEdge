...
namespace EdgeReports.Reports {
    ...
    public class SalesByDeviceSummary2 : ReportClass {
        
        public SalesByDeviceSummary2() {
        }
        
        public override string ResourceName {
            get {
                return "SalesByDeviceSummary2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.SalesByDeviceSummary2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesByDeviceSummary2 : Component, ICachedReport {
        
        public CachedSalesByDeviceSummary2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesByDeviceSummary2 rpt = new SalesByDeviceSummary2();
            rpt.Site = this.Site;
            return rpt;
        }
