...
namespace EdgeReports.Reports {
    ...
    public class PayoutsByLevel : ReportClass {
        
        public PayoutsByLevel() {
        }
        
        public override string ResourceName {
            get {
                return "PayoutsByLevel.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.PayoutsByLevel.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPayoutsByLevel : Component, ICachedReport {
        
        public CachedPayoutsByLevel() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PayoutsByLevel rpt = new PayoutsByLevel();
            rpt.Site = this.Site;
            return rpt;
        }
