...
namespace EdgeReports.Reports {
    ...
    public class Occasion : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.Occasion.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedOccasion : Component, ICachedReport {
        
        public CachedOccasion() {
        }
