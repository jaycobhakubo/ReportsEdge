...
namespace EdgeReports.Reports {
    ...
    public class SalesTotals : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.SalesTotals.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesTotals : Component, ICachedReport {
        
        public CachedSalesTotals() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesTotals rpt = new SalesTotals();
            rpt.Site = this.Site;
            return rpt;
        }
