...
namespace EdgeReports.Reports {
    ...
    public class InventoryEntry : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.InventoryEntry.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedInventoryEntry : Component, ICachedReport {
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InventoryEntry rpt = new InventoryEntry();
            rpt.Site = this.Site;
            return rpt;
        }
