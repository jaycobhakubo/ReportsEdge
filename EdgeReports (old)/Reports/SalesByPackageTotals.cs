...
namespace EdgeReports.Reports {
    ...
    public class SalesByPackageTotals : ReportClass {
        
        public SalesByPackageTotals() {
        }
        
        public override string ResourceName {
            get {
                return "SalesByPackageTotals.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.SalesByPackageTotals.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesByPackageTotals : Component, ICachedReport {
        
        public CachedSalesByPackageTotals() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesByPackageTotals rpt = new SalesByPackageTotals();
            rpt.Site = this.Site;
            return rpt;
        }
