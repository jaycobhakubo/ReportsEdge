...
namespace EdgeReports.Reports {
    ...
    public class BallCall : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgeReports.Reports.BallCall.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBallCall : Component, ICachedReport {
        
        public CachedBallCall() {
        }
