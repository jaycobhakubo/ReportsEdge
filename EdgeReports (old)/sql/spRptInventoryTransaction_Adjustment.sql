...
/****** Object:  StoredProcedure [dbo].[spRptInventoryTransaction_Adjustment]    Script Date: 05/22/2012 13:54:26 ******/
...
ivt.ivtTransactionTypeID = 22 -- Adjustments
...
BEGIN
	...
	--
	UPDATE #TempTble
	SET txLocation = (SELECT TOP 1 il.ilInvLocationName
