...
/****** Object:  StoredProcedure [dbo].[spRptSessionSummarySales]    Script Date: 01/09/2012 09:51:40 ******/
...
begin
    ...
    INSERT INTO @Sales ( opId, gameDate, sessionNbr, paper, electronic, bingoOther, pulltab, concessions, merchandise
                        ,cashPrizes, checkPrizes, merchPrizes, accrualIncreases, pullTabPrizes
                        ,beginBank, accrualPayouts, prizeFees, sessionCosts, coupons, actualCash, debitCredit, checks, endBank, deposits
	...
	SELECT @OperatorID, @GameDate, @Session, ss.PaperSales, ss.ElectronicSales, ss.BingoOtherSales, ss.PullTabSales, ss.ConcessionSales, ss.MerchandiseSales
		   ,ss.CashPrizes, ss.CheckPrizes, ss.MerchandisePrizes, ss.AccrualIncrease, ss.PullTabPrizes
