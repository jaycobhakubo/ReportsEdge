...
/****** Object:  StoredProcedure [dbo].[spRptPaperBingoSales]    Script Date: 07/11/2012 13:52:16 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spRptPaperBingoSales]') AND type in (N'P', N'PC'))
