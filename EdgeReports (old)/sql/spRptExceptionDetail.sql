...
/****** Object:  StoredProcedure [dbo].[spRptExceptionDetail]    Script Date: 06/27/2012 13:47:39 ******/
...
where 
    (original.ctrGamingDate >= @StartDate and original.ctrGamingDate <= @EndDate)       -- only filter on original transaction!
