...
/****** Object:  StoredProcedure [dbo].[spRptInventoryTransaction_Returns]    Script Date: 05/22/2012 13:39:00 ******/
...
WHERE 
(o.OperatorID = @OperatorID or @OperatorID = 0) AND						    --DE9170
ivt.ivtTransactionTypeID = 3 -- RETURN
